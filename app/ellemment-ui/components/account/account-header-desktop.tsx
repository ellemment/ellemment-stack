// app/ellemment-ui/components/account/account-header-desktop.tsx
  ...
  export function AccountHeaderDesktop({ className = '' }: AccountHeaderDesktopProps) {
    return (
      <div className={`hidden lg:flex items-center justify-between p-4 ${className}`}>
