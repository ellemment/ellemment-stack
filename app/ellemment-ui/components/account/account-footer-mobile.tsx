// app/ellemment-ui/components/account/account-footer-mobile.tsx
...
interface AccountFooterMobileProps {
  user: User;
}

export function AccountFooterMobile({ user }: AccountFooterMobileProps) {
  return (
