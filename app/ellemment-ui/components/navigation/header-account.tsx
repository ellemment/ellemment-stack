...
import { Container } from '#app/components/ui/container-account';
import NavbarContents from '#app/ellemment-ui/components/navigation/navbar-contents-account';
...
export function AccountHeader({  userPreference, className = ''}: AccountHeaderProps) {
  ...
  return (
    <MotionConfig transition={{ duration: 0.15 }}>
      <header className={`rounded-xl bg-white shadow-sm  dark:bg-zinc-900 dark:ring-white/10 ${className}`}>
        <div 
        ...
        <AnimatePresence>
          {expanded && (
            ...
            >
              ...
              >
                <div ref={navRef} className="py-6 bg-white rounded-t-xl dark:bg-zinc-900 ">
                  <Container>
